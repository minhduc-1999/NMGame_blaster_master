...
void CGame::Draw(float x, float y, LPDIRECT3DTEXTURE9 texture, int left, int top, int right, int bottom, int dir)
{
	...
	else
	{
		...
		my_sin = (float)sin(180);
		my_cos = (float)cos(180);

		matrix->_11 = 1.0f; matrix->_12 = 0.0f;   matrix->_13 = 0.0f;    matrix->_14 = 0.0f;
		matrix->_21 = 0.0f; matrix->_22 = my_cos; matrix->_23 = -my_sin;  matrix->_24 = 0.0f;
		matrix->_31 = 0.0f; matrix->_32 = my_sin; matrix->_33 = my_cos;  matrix->_34 = 0.0f;
