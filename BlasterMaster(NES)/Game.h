...
public:
	...
	void UpdateSwitchSectionCamera(DWORD dt, int nx, D3DXVECTOR2 desPos, D3DXVECTOR2 desMapPos, D3DXVECTOR2 desMapDimen) { camera->UpdateSwitchSection(dt, nx, desPos, desMapPos, desMapDimen); }
};